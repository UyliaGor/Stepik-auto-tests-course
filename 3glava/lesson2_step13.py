...
class TestRegistration(unittest.TestCase):
    def test_abs1(self):
        ...
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "No registered")
